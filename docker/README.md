...
> [!IMPORTANT]
> **安全警告**：從 v4.0.0 開始，Docker 版 Web 管理界面默認開啟強制鑒權。
...
docker tag antigravity-manager:latest lbjlaq/antigravity-manager:4.0.0
docker push lbjlaq/antigravity-manager:latest
docker push lbjlaq/antigravity-manager:4.0.0
```
